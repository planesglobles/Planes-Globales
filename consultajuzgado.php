...
<style>
  ...
  <title>CRUD Tipo de juzgado</title>
...
<header>
  ...
  <br><br><br>
  <p><a class="button" href="registrarJ.php" ><button type="button" class="btn btn-primary"><i class='fas fa-pen'></i> Registrar Tipo</button></a></p>
  <table class="table table-bordered">
    <thead>
      <tr>
        ...
        $sql = "SELECT * FROM tipodejuzgado LIMIT $empieza, $por_pagina";
        $result = $conn->query($sql);
        ?>
            <?php foreach ($result as $clave=>$valor): ?>
            <tr>
                <td><?= $valor['radicado']?></td>
                <td><?= $valor['num_juzgado']?></td>
                <td><?= $valor['tipo']?></td>
            
                

                <td><a button type="button" class="btn btn-primary" href="modificar4.php?num_juzgado=<?= $valor ['num_juzgado']?> "><i class='far fa-edit'></i> Modificar</button></a></td>
                <td><a button type="button" class="btn btn-primary" href="borrar3.php?num_juzgado=<?= $valor ['num_juzgado']?> "><i class='fas fa-trash'></i> Borrar</button></a></td>
      ...
      <?php
        ...
        echo "<a href='consultajuzgado.php?pagina=1'>".'<<'."</a>";

        for($i=1; $i<=$total_paginas; $i++){

          echo "<a href='consultajuzgado.php?pagina=".$i."'>".$i."</a>";

        }

        echo "<a href='consultajuzgado.php?pagina=$total_paginas'>".'>>'."</a>";
