...
<header>
  ...
  <div class="container">
    ...
    <br><br>
    <a class="button" href="registrarp.php" ><button type="button" class="btn btn-primary"><i class="fa fa-legal"></i> Registrar proceso</button></a>
      ...
      <tr>
        ...
        ?>
            ...
            <tr>
                ...
                <td><a button type="button" class="btn btn-primary" href="modificar1.php?radicado=<?= $valor ['radicado']?> "><i class='far fa-edit'></i> Modificar</button></a></td>
                <td><a button type="button" class="btn btn-primary" href="borrar.php?radicado=<?= $valor ['radicado']?> "><i class='fas fa-trash'></i> Borrar</button></a></td>
