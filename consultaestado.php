...
try {
  ...
  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $sql = "SELECT * FROM  estadodeproceso";
...
<head>
  ...
  <title>CRUD Estado de proceso</title>
...
<header>
  ...
  <br><br><br>
    <p><a class="button" href="registrarE.php" ><button type="button" class="btn btn-primary"><i class='fas fa-pen'></i> Registrar Estado</button></a></p>   
  <table class="table table-bordered">
    <thead>
      <tr>
        ...
        $sql = "SELECT * FROM estadodeproceso LIMIT $empieza, $por_pagina";
        $result = $conn->query($sql);
        ...
        ?>
            ...
            <tr>
                ...
                <td><?= $valor['num_proceso']?></td>
                <td><?= $valor['fecha']?></td>
                <td><?= $valor['estado']?></td>
            
                

                <td><a button type="button" class="btn btn-primary" href="modificar3.php?num_proceso=<?= $valor ['num_proceso']?> "><i class='far fa-edit'></i> Modificar</button></a></td>
                <td><a button type="button" class="btn btn-primary" href="borrar2.php?num_proceso=<?= $valor ['num_proceso']?> "><i class='fas fa-trash'></i> Borrar</button></a></td>
      ...
      <?php
        ...
        echo "<a href='consultaestado.php?pagina=1'>".'<<'."</a>";

        for($i=1; $i<=$total_paginas; $i++){

          echo "<a href='consultaestado.php?pagina=".$i."'>".$i."</a>";

        }

        echo "<a href='consultaestado.php?pagina=$total_paginas'>".'>>'."</a>";
